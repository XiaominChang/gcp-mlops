"""
Bank Marketing Campaign - XGBoost Model Training Script
Trains a binary classifier to predict term deposit subscription.
...
def main():
    input_data_path = (
        "gs://sid-ml-ops/bank_campaign_data/bank-campaign-training-data.csv"
    )
    model_name = "xgboost"
