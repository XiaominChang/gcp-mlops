...
Standalone training script for Vertex AI Custom Training Job.
Trains a Random Forest Regressor and saves the artifact to GCS.
Updated for scikit-learn >= 1.3.
"""
...
logging.basicConfig(
    filename='bikeshare_training.log',
    level=logging.INFO,
