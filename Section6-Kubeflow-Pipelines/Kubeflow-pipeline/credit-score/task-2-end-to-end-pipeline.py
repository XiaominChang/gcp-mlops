"""
Credit Scoring - Task 2: End-to-End Pipeline
- Data validation + XGBoost training + conditional deployment
- Nested conditions for quality gating
...
def model_deployment(
    project_id: str,
    bucket_name: str
) -> NamedTuple("endpoint_details", [("endpoint", str)]):
...
if __name__ == "__main__":
    compiler.Compiler().compile(
        ...
        package_path='credit-scoring-deployment.json'
    )
    print("Pipeline compiled to credit-scoring-deployment.json")
