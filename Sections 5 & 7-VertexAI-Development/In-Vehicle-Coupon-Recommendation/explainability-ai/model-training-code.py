"""
Coupon Recommendation Model Training Code
==========================================
Trains an XGBoost classifier for coupon acceptance prediction
and saves the model artifact to GCS. Used by the Explainability lab.
...
def save_model_artifact(model):
    ...
    model_artifact = bucket.blob(f"coupon-recommendation/artifacts/{artifact_name}")
